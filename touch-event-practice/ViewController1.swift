...
//    scrollView.frame = .init(x: 100, y: 200, width: 300, height: 300)
...
//
//    view1.frame = .init(x: 100, y: 200, width: 200, height: 200)
//    view1.backgroundColor = .darkGray
//
//    scrollView.addSubview(view1)
//
//    view2.frame = .init(x: 100, y: 550, width: 200, height: 200)
...
//    print("responder:view3:", view3.responderChain())
    ...
    let content = ContentView()
    content.frame = .init(x: 0, y: 60, width: 80, height: 80)
    content.backgroundColor = .brown

    let container = ContainerView(content: content)
    container.clipsToBounds = false
    container.frame = .init(x: 0, y: 0, width: 44, height: 44)
    container.backgroundColor = .blue

    let rightBarItem = UIBarButtonItem(customView: container)
